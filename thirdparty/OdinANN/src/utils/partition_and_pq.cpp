...
namespace pipeann {
  ...
  template<typename T>
  int partition_with_ram_budget(const std::string data_file, double sampling_rate, double ram_budget,
                                size_t graph_degree, const std::string partition_file, size_t num_parts) {
    size_t train_dim;
    size_t num_train;
  ...
  template void gen_random_slice<uint8_t>(const uint8_t *inputdata, size_t npts, size_t ndims, double p_val,
                                          float *&sampled_data, size_t &slice_size);
  template void gen_random_slice<int8_t>(const int8_t *inputdata, size_t npts, size_t ndims, double p_val,
                                         float *&sampled_data, size_t &slice_size);
...
template int pipeann::estimate_cluster_sizes<int8_t>(const std::string data_file, float *pivots,
                                                     const size_t num_centers, const size_t dim, const size_t k_base,
                                                     std::vector<size_t> &cluster_sizes);
template int pipeann::estimate_cluster_sizes<uint8_t>(const std::string data_file, float *pivots,
                                                      const size_t num_centers, const size_t dim, const size_t k_base,
                                                      std::vector<size_t> &cluster_sizes);
template int pipeann::estimate_cluster_sizes<float>(const std::string data_file, float *pivots,
                                                    const size_t num_centers, const size_t dim, const size_t k_base,
                                                    std::vector<size_t> &cluster_sizes);
...
template int pipeann::generate_pq_data_from_pivots<float>(const std::string data_file, unsigned num_centers,
                                                          unsigned num_pq_chunks, std::string pq_pivots_path,
                                                          std::string pq_compressed_vectors_path, size_t offset);
template int pipeann::generate_pq_data_from_pivots<knowhere::bf16>(const std::string data_file, unsigned num_centers,
                                                                   unsigned num_pq_chunks, std::string pq_pivots_path,
                                                                   std::string pq_compressed_vectors_path,
                                                                   size_t offset);
template int pipeann::generate_pq_data_from_pivots<knowhere::fp16>(const std::string data_file, unsigned num_centers,
                                                                   unsigned num_pq_chunks, std::string pq_pivots_path,
                                                                   std::string pq_compressed_vectors_path,
                                                                   size_t offset);